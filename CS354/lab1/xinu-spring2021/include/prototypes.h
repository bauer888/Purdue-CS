...
/* in file threeadd.c */
extern int threeadd(int x, int y, int z);

/* in file addthree.S */
extern int addthree(int x, int y, int z);

/* in file addtwo.S */
extern int addtwo(int x, int y);

/* in file ncreate.c */
extern pid32 ncreate(void* funcaddr, pid32 reqpid, uint32 ssize, pri16 priority, char* name, uint32 nargs, ...);
